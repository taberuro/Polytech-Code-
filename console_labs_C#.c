...
{
    Console.WriteLine("Неверный формат ввода. Введите первое число правильно");
    throw;
}
try
{
...
{
    Console.WriteLine("Неверный формат ввода. Введите знак правильно");
    throw;
}
try
{
...
{
    Console.WriteLine("Неверный формат ввода. Введите второе число правильно");
    throw;
}
...
if (z == "%")
{
    if (y==0){Console.Write("деление на ноль запрещено");}
    else if (y!=0){Console.Write(x % y);}
}
if (z == "*")
{
    Console.Write(x * y);
...
for (int m = 0; m < i; m++)
{
    for (int k = 0; k < j; k++) { array[m, k] = random.Next(100); Console.Write("{0,4}", array[m, k]);}
    Console.WriteLine();
}
